...
|*Anchor Eval* |Evaluierung, die testet, ob ein LLM einen Semantic Anchor _erkennt_ (Wissenstest, direkte Frage). |Issue #370, LLM-Coding/Semantic-Anchors 
|*Contract Eval* |Evaluierung, die testet, ob ein LLM einen Contract _einhält_ (Verhaltenstest, Aufgabe mit Systemkontext). |Issue #370, LLM-Coding/Semantic-Anchors 

...
* Contracts können optional auf https://github.com/LLM-Coding/Semantic-Anchors[Semantic Anchors] als Wissensquelle verweisen, aber auch eigenständige Steering-Regeln sein (z.B. "immer auf Deutsch antworten", "MECE-Struktur verwenden", "BLUF-Format einhalten")
...
*Hinweis:* Die Compliance-, Ethics-, Data-Privacy-, C-Level- und Betriebsrat-Stakeholder sitzen _ausserhalb der direkten Entwicklerkette_. Sie sind nicht in der Berichtslinie und konfigurieren das Plugin nicht selbst. Sie benötigen:

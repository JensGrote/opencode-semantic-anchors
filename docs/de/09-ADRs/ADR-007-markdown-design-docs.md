...
1. **Dekomposition:** Das monolithische Design-Dokument wurde vollständig in einzelne arc42-Sektionsdateien (01-introduction-and-goals.md bis 12-glossary.md) plus 08-Konzepte/ und 09-ADRs/-Verzeichnisse aufgelöst (arc42 Sektionen 8 und 9). Die originale `.adoc`-Master-Kopie wurde gelöscht.
...
- docs/08-Konzepte/01-installation.md (§8 Local Documentation Build — Schritt-für-Schritt-Anleitung)
- docs/08-Konzepte/02-update-and-maintenance.md (§4 CI/CD Pipeline — docToolchain-Stufe)
